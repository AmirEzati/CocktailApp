package info.yazdan.cocktail.data.network

import info.yazdan.cocktail.API_BASE_URL
import info.yazdan.cocktail.API_KEY
import info.yazdan.cocktail.X_RAPID_API_Host
import info.yazdan.cocktail.data.network.response.IngredientResponse
import info.yazdan.cocktail.data.network.response.IngredientsResponse
import info.yazdan.cocktail.data.network.response.SearchByIngredientResponse
